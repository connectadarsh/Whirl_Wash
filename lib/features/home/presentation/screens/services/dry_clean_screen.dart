...
// String cartKey(String itemId, String serviceId) => 'dry_clean_$itemId';

// class DryCleanScreen extends ConsumerWidget {
//   const DryCleanScreen({super.key});

//   @override
//   Widget build(BuildContext context, WidgetRef ref) {
//     final totalItems = ref.watch(cartServiceTotalProvider('dry_clean'));
//     final searchQuery = ref.watch(dryCleanSearchProvider);
//     final itemsAsync = ref.watch(itemsConfigProvider('dry_clean'));
//     final cartEntries = ref.watch(cartProvider);
//     final customItems = cartEntries.values
//         .where((e) => e.serviceId == 'dry_clean' && e.isCustom)
//         .toList();
...
//             message: 'Delicate items handled with care · Priced per kg',
//           ),
//           ServiceSearchBar(searchProvider: dryCleanSearchProvider),
//           Expanded(
...
//                           .entryFor(item.id, 'dry_clean');
//                       final cartEntry = ref.watch(
//                         cartProvider,
//                       )[cartKey(item.id, 'dry_clean')];
...
//                         onIncrement: () => ref
//                             .read(cartProvider.notifier)
//                             .increment(item.id, 'dry_clean'),
//                         onDecrement: () => ref
//                             .read(cartProvider.notifier)
//                             .decrement(item.id, 'dry_clean'),
//                         onFabricSelect: (f) => ref
//                             .read(cartProvider.notifier)
//                             .setFabric(item.id, 'dry_clean', f),
//                       );
//                     }),
//                     ...customItems.map(
//                       (e) => ServiceItemCard(
...
//                         onIncrement: () => ref
//                             .read(cartProvider.notifier)
//                             .increment(e.itemId, 'dry_clean'),
//                         onDecrement: () => ref
//                             .read(cartProvider.notifier)
//                             .decrement(e.itemId, 'dry_clean'),
//                         onFabricSelect: (f) => ref
//                             .read(cartProvider.notifier)
//                             .setFabric(e.itemId, 'dry_clean', f),
//                       ),
//                     ),
//                     _AddCustomItemCard(serviceId: 'dry_clean', hasFabric: true),
...
//         ],
//       ),
//       bottomSheet: ServiceBottomBar(totalItems: totalItems),
//     );
//   }
