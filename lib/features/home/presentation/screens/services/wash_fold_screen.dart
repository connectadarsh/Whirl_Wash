...
//     final totalItems = ref.watch(cartServiceTotalProvider('wash_fold'));
//     final searchQuery = ref.watch(washFoldSearchProvider);
//     final itemsAsync = ref.watch(itemsConfigProvider('wash_fold'));
//     final cartEntries = ref.watch(cartProvider);
//     final customItems = cartEntries.values
//         .where((e) => e.serviceId == 'wash_fold' && e.isCustom)
//         .toList();
...
//           ),
//           ServiceSearchBar(searchProvider: washFoldSearchProvider),
//           Expanded(
...
//                         onIncrement: () => ref
//                             .read(cartProvider.notifier)
//                             .increment(e.itemId, 'wash_fold'),
//                         onDecrement: () => ref
//                             .read(cartProvider.notifier)
//                             .decrement(e.itemId, 'wash_fold'),
//                         onFabricSelect: (f) => ref
//                             .read(cartProvider.notifier)
//                             .setFabric(e.itemId, 'wash_fold', f),
//                       ),
//                     ),
//                     _AddCustomItemCard(serviceId: 'wash_fold', hasFabric: true),
