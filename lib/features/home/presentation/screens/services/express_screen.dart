...
// // Stores selected service id (e.g. 'wash_fold')
// final _selectedServiceIdProvider =
//     StateProvider<String?>((ref) => null);

// // Stores selected express time
// final _selectedTimeProvider =
//     StateProvider<ExpressTimeConfig?>((ref) => null);
...
//           if (selectedServiceId != null)
//             Expanded(
//               child: _ServiceItemList(serviceId: selectedServiceId),
//             )
//           else
//             const Expanded(
//               child: Center(
...
//                 final service = entry.value;
//                 final isSelected = selectedId == service.id;
//                 final icon = _iconMap[service.icon] ??
//                     Icons.local_laundry_service_rounded;
//                 return Expanded(
//                   child: Opacity(
//                     opacity: service.enabled ? 1.0 : 0.4,
//                     child: GestureDetector(
//                       onTap: service.enabled ? () => ref
//                           .read(_selectedServiceIdProvider.notifier)
...
//                     opacity: time.enabled ? 1.0 : 0.4,
//                     child: GestureDetector(
//                       onTap: time.enabled ? () => ref
//                           .read(_selectedTimeProvider.notifier)
//                           .state = time : null,
//                       child: Container(
//                         margin: EdgeInsets.only(
//                             right: index < times.length - 1 ? 8 : 0),
...
//         borderRadius: BorderRadius.circular(12),
//         border: Border.all(
//             color: Colors.orange.withValues(alpha: 0.25), width: 1),
//       ),
//       child: Row(
//         children: [
//           Icon(Icons.bolt_rounded, size: 16, color: Colors.orange),
...
//         _isIronOnly ? ironOnlySearchProvider : washFoldSearchProvider;
//     final searchQuery = ref.watch(searchProvider);
...
//                 return _buildIronList(context, ref, filtered, searchQuery);
//               } else {
//                 return _buildWashFoldList(context, ref, filtered, searchQuery, serviceId);
//               }
//             },
//           ),
//         ),
...
//   Widget _buildWashFoldList(BuildContext context, WidgetRef ref,
//       List<ItemConfig> filtered, String searchQuery, String serviceId) {
//     final cartMap = ref.watch(cartProvider);
//     final notifier = ref.read(cartProvider.notifier);
//     final selectedTime = ref.read(_selectedTimeProvider);
//     final timeSlot = selectedTime?.id;
...
//             quantity: cartEntry?.quantity ?? 0,
//             fabric: cartEntry?.fabric,
//             onIncrement: () => notifier.increment(item.id, serviceId, isExpress: true, expressTimeSlot: timeSlot),
//             onDecrement: () => notifier.decrement(item.id, serviceId, isExpress: true),
//             onFabricSelect: (f) => notifier.setFabric(item.id, serviceId, f, isExpress: true),
//           );
//         }),
//         ...cartMap.values
//             .where((e) => e.serviceId == serviceId && e.isCustom && e.isExpress)
//             .map((e) => ServiceItemCard(
//                   isCustom: true,
//                   emoji: '🧺',
//                   name: e.customName!,
//                   quantity: e.quantity,
...
//                   onIncrement: () => notifier.increment(e.itemId, serviceId),
//                   onDecrement: () => notifier.decrement(e.itemId, serviceId),
//                   onFabricSelect: (f) => notifier.setFabric(e.itemId, serviceId, f),
//                 )),
//         _AddCustomWashFoldCard(),
//         const SizedBox(height: 12),
//       ],
...
//   Widget _buildIronList(BuildContext context, WidgetRef ref,
//       List<ItemConfig> filtered, String searchQuery) {
//     final cartMap = ref.watch(cartProvider);
//     final notifier = ref.read(cartProvider.notifier);
//     const serviceId = 'iron_only';
//     final selectedTime = ref.read(_selectedTimeProvider);
...
//       showFabric: true,
//       fabricLabel:
//           fabric == FabricType.dontKnow ? 'Select fabric' : fabric.label,
//       fabricHasSelection: fabric != FabricType.dontKnow,
//       onFabricTap: () => showModalBottomSheet(
//         context: context,
//         backgroundColor: Colors.transparent,
...
//           selected: fabric,
//           onSelect: (f) =>
//               ref.read(_exWFFabricProvider.notifier).state = f,
//         ),
//       ),
//       onAdd: () {
//         final name = controller.text.trim();
...
//                             size: 16,
//                             color: Colors.white
//                                 .withValues(alpha: qty > 1 ? 0.8 : 0.25)),
//                       ),
//                     ),
//                     Text('$qty',
//                         style: const TextStyle(
...
// });
// final _exWFQtyProvider = StateProvider.autoDispose<int>((ref) => 1);
// final _exWFFabricProvider =
//     StateProvider.autoDispose<FabricType>((ref) => FabricType.dontKnow);
// final _exIronControllerProvider =
//     Provider.autoDispose<TextEditingController>((ref) {
//   final c = TextEditingController();
//   ref.onDispose(() => c.dispose());
//   return c;
