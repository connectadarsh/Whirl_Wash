...
// String cartKey(String itemId, String serviceId) => 'wash_iron_$itemId';
...
//     final totalItems = ref.watch(cartServiceTotalProvider('wash_iron'));
...
//                           .entryFor(item.id, 'wash_iron');
//                       final cartEntry = ref.watch(
//                         cartProvider,
//                       )[cartKey(item.id, 'wash_iron')];
