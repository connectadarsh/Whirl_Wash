...
//     final totalItems = ref.watch(cartServiceTotalProvider('iron_only'));
//     final searchQuery = ref.watch(ironOnlySearchProvider);
//     final itemsAsync = ref.watch(itemsConfigProvider('iron_only'));
//     final cartEntries = ref.watch(cartProvider);
//     final customItems = cartEntries.values
//         .where((e) => e.serviceId == 'iron_only' && e.isCustom)
//         .toList();
...
//           ),
//           ServiceSearchBar(searchProvider: ironOnlySearchProvider),
//           Expanded(
