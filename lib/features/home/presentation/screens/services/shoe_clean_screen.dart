...
//     final totalItems = ref.watch(cartServiceTotalProvider('shoe_clean'));
//     final searchQuery = ref.watch(shoeCleanSearchProvider);
//     final itemsAsync = ref.watch(itemsConfigProvider('shoe_clean'));
//     final cartEntries = ref.watch(cartProvider);
//     final customItems = cartEntries.values
//         .where((e) => e.serviceId == 'shoe_clean' && e.isCustom)
//         .toList();
...
//             message:
//                 'Priced per pair · Final amount set by admin after cleaning',
//           ),
//           ServiceSearchBar(searchProvider: shoeCleanSearchProvider),
//           Expanded(
...
//                         onIncrement: () => ref
//                             .read(cartProvider.notifier)
//                             .increment(e.itemId, 'shoe_clean'),
//                         onDecrement: () => ref
//                             .read(cartProvider.notifier)
//                             .decrement(e.itemId, 'shoe_clean'),
//                       ),
//                     ),
//                     _AddCustomItemCard(
