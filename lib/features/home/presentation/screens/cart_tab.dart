...
//         child: Column(
//           children: [
//             // Express card — shown first if any express items
...
//   @override
//   Widget build(BuildContext context, WidgetRef ref) {
//     // Get time slot from first express item
//     final timeSlot = items.first.expressTimeSlot;

//     // Group express items by serviceId
//     final grouped = <String, List<CartEntry>>{};
...
//           // Show items grouped by service inside express card
//           ...grouped.entries.map((group) {
...
//       child: Row(
//         children: [
//           // Avatar — first letter for custom, icon container for regular
//           Container(
//             width: 44,
//             height: 44,
//             decoration: BoxDecoration(
...
//             SnackBar(
//               content: const Text('Order placement — Coming soon'),
